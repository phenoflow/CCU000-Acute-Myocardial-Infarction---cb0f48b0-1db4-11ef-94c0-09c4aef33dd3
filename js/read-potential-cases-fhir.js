...
(async () => {
  ...
  await fs.writeFile("ccu000-acute-myocardial-infarction-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ccu000-acute-myocardial-infarction-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
